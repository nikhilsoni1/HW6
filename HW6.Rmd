...
**When running the code from the chunk, the output is as follows. This is drastically different from the knitted result, which doesnt change at all. It is an issue with R and how it handles RMarkdown chunks**

![Chunk Output](assets/iid.png)
